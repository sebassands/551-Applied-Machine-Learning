...
# Decision tree on twenty dataset ############# ORIGINAL HYPER-PARAMETERS FROM SKLEARN###################################
...
parameters = {
    ...
    'clf__min_samples_split': [10,20,30,40,50,100,200,300,400,500],
    'clf__max_depth': [1000,500,2000,3000,4000],
...
# Decision tree on twenty dataset ############# Tuned HYPER-PARAMETERS FROM SKLEARN###################################
...
clss=text_clf.fit(X_train, y_train)
print(f'training time: {time.time()-start}')
#Decision Trees (accuracy)
